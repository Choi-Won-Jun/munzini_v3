...
const PATTERN_NAME = {"칠정", "노권", "담음", "식적", "어혈"}	// 변증 이름
const PATTERN_INDEX = {"칠정" : 0, "노권" : 1, "담음" : 2, "식적" : 3, "어혈" : 4}	// 변증 인덱스 : 이름
...
type QData struct {
	...
	FinalScore	[]float32	// 간단한 문진 이후 컷오프 값을 넘긴 Pattern 인덱스 에 대한 표준점수 슬라이스
}
